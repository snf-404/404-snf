...
const SOUND_URLS: Record<string, string> = {
  mouse_click:
    'https://mdn.alipayobjects.com/asap_serivce/uri/file/as/mouse-click-290204.1770035062038.mp3',
...
useEffect(() => {
  const audio = new Audio(
    'https://mdn.alipayobjects.com/asap_serivce/uri/file/as/meditation-background-434654.1770035112439.mp3',
  )
  audio.loop = true
  setBgmAudio(audio)
  return () => {
