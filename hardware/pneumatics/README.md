...
| 3   | Driver          | **Dual TB6612FNG breakout** (SparkFun/Pololu) _or_ 2× **IRF520 MOSFET module**            | GPIO + PWM | 1 · $3–8    | Logic-level, no soldering IC, one board drives pump **and** valve |
